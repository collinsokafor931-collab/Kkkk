...
import { X, Clock, ShieldCheck, Sparkles, Check, ChevronRight, HelpCircle, ArrowRight, Share2, Layers, Truck, Lock } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            {onOpenAdminSpace && (
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-stone-900 hover:bg-black text-[#e5c07b] hover:text-white transition-colors cursor-pointer text-xs flex items-center gap-1.5 shadow-xs border border-stone-700"
                title="Manage Space in Admin (Password Protected)"
              >
                <Lock className="w-3.5 h-3.5 text-[#e5c07b]" />
                <span className="font-medium">Admin Space</span>
              </button>
            )}
